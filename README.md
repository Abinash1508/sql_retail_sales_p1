...
This project involves analyzing a retail sales dataset loaded into SQL Server Management Studio (SSMS). The goal is to explore, clean, and analyze sales records to identify customer trends, product performance, and sales patterns across different time shifts. Data cleaning and SQL queries were used to ensure data accuracy and generate key business insights.
